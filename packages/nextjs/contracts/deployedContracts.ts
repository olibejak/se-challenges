...
const deployedContracts = {
  ...
  11155111: {
    DEX: {
      address: "0x5d6cAe92b1B78461a1Ad8B5CE5c00E15f5450dc7",
      abi: [
        {
          inputs: [
            {
      ...
      inheritedFunctions: {},
      deployedOnBlock: 9705048,
    },
    MyUSD: {
      address: "0x20F5b93BB365b39291D0db550D8875F815A3BdE9",
      abi: [
        {
          inputs: [
            {
      ...
      deployedOnBlock: 9705046,
    },
    MyUSDEngine: {
      address: "0x20Cfd29e163509d14dD7F6e61ebeB3Cd6298071B",
      abi: [
        {
          inputs: [
            {
      ...
      deployedOnBlock: 9705052,
    },
    MyUSDStaking: {
      address: "0xCd7633ffc82bcd7b1C8F921eFc49272Adb74A0C4",
      abi: [
        {
          inputs: [
            {
      ...
      deployedOnBlock: 9705051,
    },
    Oracle: {
      address: "0xc4217954FEeDD338bfC91474F426e1f46746c79f",
      abi: [
        {
          inputs: [
            {
      ...
      inheritedFunctions: {},
      deployedOnBlock: 9705050,
    },
    RateController: {
      address: "0x83E188674A540603eFB60f33fc8069e4DB42C6a3",
      abi: [
        {
          inputs: [
            {
